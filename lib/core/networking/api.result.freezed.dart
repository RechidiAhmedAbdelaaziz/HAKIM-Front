...
mixin _$ApiResult<T> {
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(_Sucess<T> value) sucess,
    required TResult Function(_Failure<T> value) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? mapOrNull<TResult extends Object?>({
    TResult? Function(_Sucess<T> value)? sucess,
...
abstract class _Sucess<T> implements ApiResult<T> {
  const factory _Sucess(final T data) = _$SucessImpl<T>;
...
abstract class _Failure<T> implements ApiResult<T> {
  const factory _Failure(final ErrorHandler error) = _$FailureImpl<T>;
